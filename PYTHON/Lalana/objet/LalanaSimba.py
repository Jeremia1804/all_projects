from objet.CoordonneeInfra import CoordonneeInfra
from Fonction import Fonction
from objet.Cout import Cout
...
class LalanaSimba:
    ...
    def calculCout(self,conn,largeur):
        total=0
    ...
    #     idrn = self.getIdLalana()
    #     idinfra = 3
    #     pk1 = self.getPk1().getValeur()
    #     pk2 = self.getPk2().getValeur()
    ...
    def getPriority(conn,lalana,rayon):
        ...
        lalanaH = LalanaSimba.trierHopital(conn,lalana,rayon)
        lalanaP = LalanaSimba.trierPopulation(conn,lalana,rayon)
        lalan = []
        for i in lalana:
