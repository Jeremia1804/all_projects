class Taquin{
    ...
    changeBackground(){
        ...
        for (let i = 0; i < 4; i++){
            for (let j = 0 ; j < 4; j++){
                ...
                let elementID = "photo" + ((i*4 + j+1)%16);
    ...
    markLegalMoves(){
        ...
        for (let i = 0; i < 4; i++) {
            for (let j = 0; j < 4; j++) {
                ...
                document.getElementById("photo" + ((4*i+j+1)%16).toString()).style.cursor = "not-allowed";
                for (let z = 0; z < legalMove.length; z++){
                    ...
                    if (pickedCase.toString() === legalMove[z].toString()){
                        ...
                        if (!this.solvedByPlayer){
                            document.getElementById("photo" + ((4*i+j+1)%16).toString()).style.cursor = "pointer";
                        }
    ...
    addListeners(){
        ...
        shuffle.addEventListener("click", function () {
            ...
            taquin.getGrid().randomiseGrid(70);
            taquin.changeBackground();
