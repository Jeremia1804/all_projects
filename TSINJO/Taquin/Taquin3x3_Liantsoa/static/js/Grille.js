class Grille {
    ...
    createGrid(){
        let g = [
            [new Case(0,0, 1), new Case(0,1, 2), new Case(0,2, 3)],
            [new Case(1,0, 4), new Case(1,1, 5), new Case(1,2, 6)],
            [new Case(2,0, 7), new Case(2,1, 8), new Case(2,2, 0)]
        ];
        return g;
    }
    ...
    printGrid() {
        for (let i = 0; i < 3; i++){
                console.log(this.grille[i][0] + " " + this.grille[i][1] + " " + this.grille[i][2]);
        }
    }
